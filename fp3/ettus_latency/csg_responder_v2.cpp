        ...
        if (level_calibration_countdown > 0)
        {
            ...
            if (level_calibration_countdown <= 0)
            {
                if (level_calibration_stage_2 == false)
                {
                    ...
                    //CSG_2_19 threshold = trigger_level;//CSG_2_19
...
//org            else//org
            ...
            //CSG 2_27 if (simulate_duration > 0)
            //CSG 2_27     new_state = (((num_total_samps + n) % simulate_duration) == 0);
            //CSG 2_27 else
