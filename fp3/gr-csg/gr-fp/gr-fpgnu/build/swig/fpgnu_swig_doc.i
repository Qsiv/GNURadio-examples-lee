...
%feature("docstring") std::array "STL class."
...
%feature("docstring") std::forward_list::const_iterator "STL iterator class."

%feature("docstring") std::unordered_map::const_iterator "STL iterator class."
...
%feature("docstring") std::unordered_multimap::const_iterator "STL iterator class."
...
%feature("docstring") std::unordered_set::const_iterator "STL iterator class."
...
%feature("docstring") std::unordered_multiset::const_iterator "STL iterator class."
...
%feature("docstring") std::unordered_map::const_reverse_iterator "STL iterator class."
...
%feature("docstring") std::unordered_multimap::const_reverse_iterator "STL iterator class."
...
%feature("docstring") std::unordered_set::const_reverse_iterator "STL iterator class."
...
%feature("docstring") std::unordered_multiset::const_reverse_iterator "STL iterator class."

%feature("docstring") std::vector::const_reverse_iterator "STL iterator class."

%feature("docstring") std::forward_list::const_reverse_iterator "STL iterator class."
...
%feature("docstring") std::error_category "STL class."

%feature("docstring") std::error_code "STL class."

%feature("docstring") std::error_condition "STL class."

%feature("docstring") std::exception "STL class."

%feature("docstring") std::ios_base::failure "STL class."

%feature("docstring") std::forward_list "STL class."

%feature("docstring") gr::fpgnu::fp_CandC "<+description of block+>"

%feature("docstring") gr::fpgnu::fp_CandC::make "Return a shared_ptr to a new instance of fpgnu::fp_CandC.

To avoid accidental use of raw pointers, fpgnu::fp_CandC's constructor is in a private implementation class. fpgnu::fp_CandC::make is the public interface for creating new instances.

Params: (NONE)"

%feature("docstring") gr::fpgnu::fpdata_sink "<+description of block+>"

%feature("docstring") gr::fpgnu::fpdata_sink::make "Return a shared_ptr to a new instance of fpgnu::fpdata_sink.
...
%feature("docstring") gr::fpgnu::fpdata_source "<+description of block+>"

%feature("docstring") gr::fpgnu::fpdata_source::make "Return a shared_ptr to a new instance of fpgnu::fpdata_source.

To avoid accidental use of raw pointers, fpgnu::fpdata_source's constructor is in a private implementation class. fpgnu::fpdata_source::make is the public interface for creating new instances.
...
%feature("docstring") std::unordered_multiset::reverse_iterator "STL iterator class."
...
%feature("docstring") std::unordered_map::reverse_iterator "STL iterator class."
...
%feature("docstring") std::unordered_set::reverse_iterator "STL iterator class."

%feature("docstring") std::forward_list::reverse_iterator "STL iterator class."
...
%feature("docstring") std::unordered_multimap::reverse_iterator "STL iterator class."
...
%feature("docstring") std::system_error "STL class."

%feature("docstring") std::thread "STL class."
...
%feature("docstring") std::unordered_map "STL class."

%feature("docstring") std::unordered_multimap "STL class."

%feature("docstring") std::unordered_multiset "STL class."

%feature("docstring") std::unordered_set "STL class."
